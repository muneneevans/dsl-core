...
facility_urls = [
    ...
    url(r'^county/(?P<county_id>[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[89aAbB][a-f0-9]{3}-[a-f0-9]{12})/summary/detailed/$',CountyDetailedSummary.as_view(), name='county-detailed-summary'),
